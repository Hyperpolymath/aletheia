...
:experimental:
:url-github: https://github.com/hyperpolymath/aletheia
:url-gitlab: https://gitlab.com/hyperpolymath/aletheia
:url-bitbucket: https://bitbucket.org/hyperpolymath/aletheia
:url-codeberg: https://codeberg.org/hyperpolymath/aletheia

Truth verification and fact-checking automation framework
...
aletheia is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
